...
import { defaultParams, IADSApiSearchParams, IADSApiSearchResponse, SEARCH_API_KEYS, SolrSort } from '@/api';
...
import { ISearchFacetsProps } from '@/components/SearchFacet/SearchFacet';
...
const Page = async () => {
  ...
  const results = await getSearchResults(parseQueryFromUrl(searchParams.toString()));
  console.log('results', results);

  return <Code>{JSON.stringify(results)}</Code>;
};
export default Page;
