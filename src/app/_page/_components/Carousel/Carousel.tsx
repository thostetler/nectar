...
export const Carousel = () => {
  ...
  // min height to prevent page from jumping around
  const pageMinHeight = '30em';
        ...
        pages={[
          {
            uniqueId: 'welcome',
            content: (
              <Stack minH={pageMinHeight} flexDirection="column" textAlign="left" spacing="4">
                <Heading as="h3">
          ...
          },
          {
            ...
            content: (
              <Stack  minH={pageMinHeight}flexDirection="column" textAlign="left" spacing="4">
                ...
                />
                <Text fontSize="xl">
                  SciX covers and unifies the fields of Earth Science, Planetary Science, Astrophysics, and
          ...
          },
          {
            uniqueId: 'new-user',
            content: (
              <Stack  minH={pageMinHeight}flexDirection="column" textAlign="left" spacing="8">
                <Heading as="h3">
                ...
                <Text fontSize="xl">
                  ...
                  to start your search of the portal and find out where to go with any questions about advanced tools
                  and features.
                </Text>
              </Stack>
            ),
          },
          {
            ...
            content: <SearchExamples minH={pageMinHeight} />,
          },
        ]}
      />
    </Box>
